...
class Pose:
    ...
    def apply_world_motion(self, motion_delta_robot, dt, theta_prev):
        ...
        self.delta_x = (delta_x_r*math.cos(theta_prev) - delta_y_r*math.sin(theta_prev))*dt
        self.delta_y = (delta_x_r*math.sin(theta_prev) + delta_y_r*math.cos(theta_prev))*dt
