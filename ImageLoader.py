...
pixels_standardised = z_standardise(im_greyscale)
pixels_normalized_disp = normalize_to_image_space(pixels_standardised)
...
cv2.imshow('Level 0',pixels_normalized_disp)
