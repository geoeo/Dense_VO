...
SE3_est = Solver.solve_photometric(frame_reference, frame_target, 20000, 0.01, alpha_step=1.0, use_ndc = use_ndc, debug = False)# - Synth Y
#SE3_est = Solver.solve_photometric(frame_reference, frame_target, 20000, 1.0, alpha_step=1.0, use_ndc = use_ndc, debug = False)
